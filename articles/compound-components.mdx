...
category: 'React'
coverImage: 'photo-1522111608460-19e7331e00fb?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8'
date: '2022-03-09T07:28:29.128Z'
author:
  name:
  picture:
ogImage:
  url: 'https://images.unsplash.com/photo-1522111608460-19e7331e00fb?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1200&q=80'
description: '2개 이상의 컴포넌트를 조합해서 한 가지 기능을 수행하는 컴포넌트를 만드는 기법에 대해 소개합니다.'
---
